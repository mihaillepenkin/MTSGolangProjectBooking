...
type Repository interface {
	...
	IsIntersected(ctx context.Context, hotelID int64, roomID int64, checkIn time.Time, checkOut time.Time) (bool, error)
	...
	GetDurationsByRoom(ctx context.Context, hotelID int64, roomID int64) ([][]time.Time, error)
